import 'dart:convert';
import 'package:talabatcom/features/brands/controllers/brands_controller.dart';
import 'package:talabatcom/features/brands/domain/repositories/brands_repository.dart';
import 'package:talabatcom/features/brands/domain/repositories/brands_repository_interface.dart';
import 'package:talabatcom/features/brands/domain/services/brands_service.dart';
import 'package:talabatcom/features/brands/domain/services/brands_service_interface.dart';
import 'package:talabatcom/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:talabatcom/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:talabatcom/features/home/controllers/home_controller.dart';
import 'package:talabatcom/features/home/domain/repositories/home_repository.dart';
import 'package:talabatcom/features/home/domain/repositories/home_repository_interface.dart';
import 'package:talabatcom/features/home/domain/services/home_service.dart';
import 'package:talabatcom/features/home/domain/services/home_service_interface.dart';
import 'package:talabatcom/features/taxi_booking/controllers/booking_checkout_controller.dart';
import 'package:talabatcom/features/taxi_booking/controllers/car_selection_controller.dart';
...
import 'package:talabatcom/features/banner/domain/repositories/banner_repository.dart';
import 'package:talabatcom/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:talabatcom/features/banner/domain/services/banner_service.dart';
import 'package:talabatcom/features/banner/domain/services/banner_service_interface.dart';
import 'package:talabatcom/features/cart/domain/repositories/cart_repository.dart';
import 'package:talabatcom/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:talabatcom/features/cart/domain/services/cart_service.dart';
...
import 'package:talabatcom/features/category/domain/reposotories/category_repository.dart';
import 'package:talabatcom/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:talabatcom/features/category/domain/services/category_service.dart';
import 'package:talabatcom/features/category/domain/services/category_service_interface.dart';
import 'package:talabatcom/features/chat/controllers/chat_controller.dart';
import 'package:talabatcom/features/chat/domain/repositories/chat_repository.dart';
import 'package:talabatcom/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:talabatcom/features/chat/domain/services/chat_service.dart';
import 'package:talabatcom/features/chat/domain/services/chat_service_interface.dart';
import 'package:talabatcom/features/coupon/controllers/coupon_controller.dart';
import 'package:talabatcom/features/coupon/domain/services/coupon_service.dart';
import 'package:talabatcom/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:talabatcom/features/favourite/controllers/favourite_controller.dart';
import 'package:talabatcom/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:talabatcom/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:talabatcom/features/favourite/domain/services/favourite_service.dart';
import 'package:talabatcom/features/favourite/domain/services/favourite_service_interface.dart';
import 'package:talabatcom/features/flash_sale/controllers/flash_sale_controller.dart';
import 'package:talabatcom/features/flash_sale/domain/repositories/flash_sale_repository.dart';
import 'package:talabatcom/features/flash_sale/domain/repositories/flash_sale_repository_interface.dart';
import 'package:talabatcom/features/flash_sale/domain/services/flash_sale_service.dart';
import 'package:talabatcom/features/flash_sale/domain/services/flash_sale_service_interface.dart';
import 'package:talabatcom/features/html/controllers/html_controller.dart';
import 'package:talabatcom/features/html/domain/repositories/html_repository.dart';
import 'package:talabatcom/features/html/domain/repositories/html_repository_interface.dart';
import 'package:talabatcom/features/html/domain/services/html_service.dart';
import 'package:talabatcom/features/html/domain/services/html_service_interface.dart';
...
import 'package:talabatcom/features/item/domain/repositories/campaign_repository.dart';
import 'package:talabatcom/features/item/domain/repositories/campaign_repository_interface.dart';
import 'package:talabatcom/features/item/domain/repositories/item_repository.dart';
import 'package:talabatcom/features/item/domain/repositories/item_repository_interface.dart';
import 'package:talabatcom/features/item/domain/services/campaign_service.dart';
import 'package:talabatcom/features/item/domain/services/campaign_service_interface.dart';
import 'package:talabatcom/features/item/domain/services/item_service.dart';
...
import 'package:talabatcom/features/language/domain/repository/language_repository.dart';
import 'package:talabatcom/features/language/domain/repository/language_repository_interface.dart';
import 'package:talabatcom/features/language/domain/service/language_service.dart';
import 'package:talabatcom/features/language/domain/service/language_service_interface.dart';
...
import 'package:talabatcom/features/taxi_booking/repo/car_selection_repo.dart';
import 'package:talabatcom/features/taxi_booking/repo/cart_repo.dart';
import 'package:talabatcom/features/taxi_booking/repo/rider_repo.dart';
...
import 'package:talabatcom/features/address/domain/repositories/address_repository.dart';
import 'package:talabatcom/features/address/domain/repositories/address_repository_interface.dart';
import 'package:talabatcom/features/address/domain/services/address_service.dart';
import 'package:talabatcom/features/address/domain/services/address_service_interface.dart';
import 'package:talabatcom/features/auth/controllers/auth_controller.dart';
import 'package:talabatcom/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:talabatcom/features/auth/controllers/store_registration_controller.dart';
import 'package:talabatcom/features/auth/domain/reposotories/auth_repository.dart';
import 'package:talabatcom/features/auth/domain/reposotories/auth_repository_interface.dart';
import 'package:talabatcom/features/auth/domain/reposotories/deliveryman_registration_repository.dart';
import 'package:talabatcom/features/auth/domain/reposotories/deliveryman_registration_repository_interface.dart';
import 'package:talabatcom/features/auth/domain/reposotories/store_registration_repository.dart';
import 'package:talabatcom/features/auth/domain/reposotories/store_registration_repository_interface.dart';
import 'package:talabatcom/features/auth/domain/services/auth_service.dart';
import 'package:talabatcom/features/auth/domain/services/auth_service_interface.dart';
import 'package:talabatcom/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:talabatcom/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:talabatcom/features/auth/domain/services/store_registration_service.dart';
import 'package:talabatcom/features/auth/domain/services/store_registration_service_interface.dart';
...
import 'package:talabatcom/features/checkout/domain/services/checkout_service.dart';
import 'package:talabatcom/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:talabatcom/features/location/domain/repositories/location_repository.dart';
import 'package:talabatcom/features/location/domain/repositories/location_repository_interface.dart';
import 'package:talabatcom/features/location/domain/services/location_service.dart';
import 'package:talabatcom/features/location/domain/services/location_service_interface.dart';
import 'package:talabatcom/features/loyalty/controllers/loyalty_controller.dart';
import 'package:talabatcom/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:talabatcom/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:talabatcom/features/loyalty/domain/services/loyalty_service.dart';
import 'package:talabatcom/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:talabatcom/features/notification/controllers/notification_controller.dart';
import 'package:talabatcom/features/notification/domain/repository/notification_repository.dart';
import 'package:talabatcom/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:talabatcom/features/notification/domain/service/notification_service.dart';
import 'package:talabatcom/features/notification/domain/service/notification_service_interface.dart';
import 'package:talabatcom/features/onboard/controllers/onboard_controller.dart';
import 'package:talabatcom/features/onboard/domain/repository/onboard_repository.dart';
import 'package:talabatcom/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:talabatcom/features/onboard/domain/service/onboard_service.dart';
...
import 'package:talabatcom/features/order/domain/repositories/order_repository.dart';
import 'package:talabatcom/features/order/domain/repositories/order_repository_interface.dart';
import 'package:talabatcom/features/order/domain/services/order_service.dart';
import 'package:talabatcom/features/order/domain/services/order_service_interface.dart';
import 'package:talabatcom/features/parcel/controllers/parcel_controller.dart';
import 'package:talabatcom/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:talabatcom/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:talabatcom/features/parcel/domain/services/parcel_service.dart';
import 'package:talabatcom/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:talabatcom/features/payment/controllers/payment_controller.dart';
import 'package:talabatcom/features/payment/domain/repositories/payement_repository.dart';
import 'package:talabatcom/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:talabatcom/features/payment/domain/services/payment_service.dart';
import 'package:talabatcom/features/payment/domain/services/payment_service_interface.dart';
import 'package:talabatcom/features/profile/controllers/profile_controller.dart';
import 'package:talabatcom/features/profile/domain/repositories/profile_repository.dart';
import 'package:talabatcom/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:talabatcom/features/profile/domain/services/profile_service.dart';
import 'package:talabatcom/features/profile/domain/services/profile_service_interface.dart';
import 'package:talabatcom/features/review/controllers/review_controller.dart';
import 'package:talabatcom/features/review/domain/repositories/review_repository.dart';
import 'package:talabatcom/features/review/domain/repositories/review_repository_interface.dart';
import 'package:talabatcom/features/review/domain/services/review_service.dart';
import 'package:talabatcom/features/review/domain/services/review_service_interface.dart';
import 'package:talabatcom/features/search/controllers/search_controller.dart';
import 'package:talabatcom/features/search/domain/repositories/search_repository.dart';
import 'package:talabatcom/features/search/domain/repositories/search_repository_interface.dart';
import 'package:talabatcom/features/search/domain/services/search_service.dart';
import 'package:talabatcom/features/search/domain/services/search_service_interface.dart';
import 'package:talabatcom/features/splash/controllers/splash_controller.dart';
import 'package:talabatcom/features/splash/domain/repositories/splash_repository.dart';
import 'package:talabatcom/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:talabatcom/features/splash/domain/services/splash_service.dart';
import 'package:talabatcom/features/splash/domain/services/splash_service_interface.dart';
import 'package:talabatcom/features/store/controllers/store_controller.dart';
import 'package:talabatcom/features/store/domain/repositories/store_repository.dart';
import 'package:talabatcom/features/store/domain/repositories/store_repository_interface.dart';
import 'package:talabatcom/features/store/domain/services/store_service.dart';
import 'package:talabatcom/features/store/domain/services/store_service_interface.dart';
import 'package:talabatcom/features/verification/controllers/verification_controller.dart';
import 'package:talabatcom/features/verification/domein/reposotories/verification_repository.dart';
import 'package:talabatcom/features/verification/domein/reposotories/verification_repository_interface.dart';
import 'package:talabatcom/features/verification/domein/services/verification_service.dart';
import 'package:talabatcom/features/verification/domein/services/verification_service_interface.dart';
import 'package:talabatcom/features/wallet/controllers/wallet_controller.dart';
import 'package:talabatcom/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:talabatcom/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:talabatcom/features/wallet/domain/services/wallet_service.dart';
import 'package:talabatcom/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:talabatcom/util/app_constants.dart';
import 'package:talabatcom/features/language/domain/models/language_model.dart';
