...
import 'package:talabatcom/common/widgets/corner_banner/positioned_banner.dart';
              ...
              children:  [
                Text(
                  discount! > 0 ? '$discount${discountType == 'percent' ? '%'
                      : Get.find<SplashController>().configModel!.currencySymbol} ${'offer'.tr}' : 'free_delivery'.tr,
