...
import 'package:talabatcom/features/checkout/domain/models/distance_model.dart';
...
import 'package:talabatcom/features/checkout/domain/models/timeslote_model.dart';
import 'package:talabatcom/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:talabatcom/features/checkout/widgets/order_successfull_dialog.dart';
import 'package:talabatcom/features/checkout/widgets/partial_pay_dialog_widget.dart';
import 'package:talabatcom/features/home/screens/home_screen.dart';
import 'package:talabatcom/helper/auth_helper.dart';
import 'package:talabatcom/helper/network_info.dart';
...
class CheckoutController extends GetxController implements GetxService {
  ...
  Future<void> placePrescriptionOrder(
      ...
      double maxCodAmount,
      bool fromCart,
      bool isCashOnDeliveryActive,String area,) async {
    List<MultipartBody> multiParts = [];
    for (XFile file in orderAttachment) {
      multiParts.add(MultipartBody('order_attachment[]', file));
    }
