...
import 'package:talabatcom/features/location/widgets/permission_dialog_widget.dart';
...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  Future<void> fetchAreas() async {
    var zone_id =  AddressHelper
        .getUserAddressFromSharedPref()!.zoneId;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
          title: widget.forGuest ? 'set_address'.tr : widget.address == null
              ? 'add_new_address'.tr
              : 'update_address'.tr),
      body: SafeArea(
        child: GetBuilder<ProfileController>(builder: (profileController) {
          if (widget.address != null) {
            ...
            _contactPersonNameController.text =
            '${profileController.userInfoModel!.fName} ${profileController
                .userInfoModel!.lName}';
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      CustomTextField(
                                        ...
                                        countryDialCode: _countryDialCode ?? Get
                                      ...
                                      SizedBox(
                                          height: widget.forGuest ? Dimensions
                                              .paddingSizeLarge : 0),

                                      CustomTextField(
                                        showTitle: true,
                                        hintText: ' ',
                                        titleText: '${'street_number'
                                            .tr} (${'optional'.tr})',
                                        inputType: TextInputType.streetAddress,
                ...
                child: Center(child: SizedBox(width: Dimensions.webMaxWidth,
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          //           : const SizedBox(),
                          //       Center(
                          //           child: !locationController.loading ? Image
                          //               .asset(Images.pickMarker, height: 50,
                          //               width: 50)
                          //               : const CircularProgressIndicator()),
                          //       Positioned(
                          //         bottom: 10, right: 0,
                          ...
                          //                     Dimensions.radiusSmall),
                          //                 color: Colors.white),
                          //             child: Icon(Icons.fullscreen, color: Theme
                          //                 .of(context)
                          //                 .primaryColor, size: 20),
                          //           ),
                          //         ),
                          ...
                          SizedBox(height: 50, child: ListView.builder(
                            shrinkWrap: true,
                            scrollDirection: Axis.horizontal,
                            itemCount: locationController.addressTypeList
                                .length,
                            itemBuilder: (context, index) =>
                                Padding(
                                  padding: const EdgeInsets.only(
                              ...
                              child: DropdownButton<String>(
                                ...
                                onChanged: (String? newValue) {
                                  setState(() {
                                    ...
                                    minimumCharge is int ? minimumCharge
                                        .toDouble() : minimumCharge;
                          ...
                          SizedBox(height: widget.forGuest ? Dimensions
                              .paddingSizeLarge : 0),

                          CustomTextField(
                            titleText: '${'street_number'.tr} (${'optional'
                                .tr})',
                            inputType: TextInputType.streetAddress,
                            focusNode: _streetNode,
                            nextFocus: _houseNode,
  ...
  AddressModel? _prepareAddressModel(LocationController locationController,
    ...
    String? addressType = locationController.addressTypeList[locationController
        .addressTypeIndex];
    ...
    if (_addressController.text.isEmpty) {
      ...
      AddressModel addressModel = AddressModel(
        ...
        contactPersonNumber: _countryDialCode! +
            _contactPersonNumberController.text,
        address: selectedCity! +" "+ _addressController.text,
        latitude: AddressHelper
            .getUserAddressFromSharedPref()!.latitude.toString(),
        longitude: AddressHelper
            .getUserAddressFromSharedPref()!.longitude.toString(),
  ...
  void _addAddress(AddressModel addressModel) {
    Get.find<AddressController>().addAddress(
        addressModel, widget.fromCheckout, widget.zoneId).then((response) {
      if (response.isSuccess) {
        widget.fromNavBar ? Get.back() : Get.offNamed(
  ...
  void _updateAddress(AddressModel addressModel) {
    Get.find<AddressController>().updateAddress(
        addressModel, widget.address!.id).then((response) {
      if (response.isSuccess) {
        Get.back();
