...
import 'package:talabatcom/features/parcel/domain/models/place_details_model.dart';
import 'package:talabatcom/features/parcel/domain/models/video_content_model.dart';
import 'package:talabatcom/features/parcel/domain/models/why_choose_model.dart';
...
class ParcelControllerNew extends GetxController implements GetxService{
  ...
  var senderPrice = ''.obs;
  var receiverPrice = ''.obs;

  void updateLocation(String location) {
    selectedLocation.value = location;
  }
  void updateSenderPrice(String updateSender) {
    senderPrice.value = updateSender;
  }
  void updateReceiverPrice(String updateReceiver) {
    receiverPrice.value = updateReceiver;
  }
}
