...
import 'package:talabatcom/features/parcel/widgets/parcel_view_widget.dart';
...
class _ParcelLocationScreenState extends State<ParcelLocationScreen>
  ...
  bool firstTime = true;
  final ParcelControllerNew parcelControllerNew = Get.find<ParcelControllerNew>();
          ...
          if (_tabController!.index == 0) {
            ...
            if (parcelControllerNew.receiverPrice.value.isEmpty) {
              ...
              AddressModel destination = AddressModel(
                address: parcelControllerNew.selectedLocation.value,
                additionalAddress:
