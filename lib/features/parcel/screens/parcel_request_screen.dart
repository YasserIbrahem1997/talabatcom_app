...
import 'package:talabatcom/features/payment/widgets/offline_payment_button.dart';
import 'package:talabatcom/features/checkout/widgets/payment_button.dart';
import 'package:talabatcom/features/checkout/widgets/tips_widget.dart';
import 'package:talabatcom/features/parcel/widgets/card_widget.dart';
import 'package:talabatcom/features/parcel/widgets/delivery_instruction_bottom_sheet_widget.dart';
import 'package:talabatcom/features/parcel/widgets/details_widget.dart';
...
class _ParcelRequestScreenState extends State<ParcelRequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double convertPriceRec = double.parse(parcelControllerNew.receiverPrice.value.toString());
